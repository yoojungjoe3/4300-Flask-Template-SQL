...
def vector_search(user_query):
    ...
    if not names:
        print("Warning: No records loaded from init.sql.")
        return {}, None, None
    ...
    # Compute similarities for fandoms
    ...
    # Compute similarities for ships
    ...
    if not total_sim_dict:
        return total_sim_dict, None, None
